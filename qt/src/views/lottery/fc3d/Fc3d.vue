...
const cpTitle = ref('福彩3D')
const userBalance = ref('0.00')
const lotteryCode = ref('fc3d') // 彩种代码 - 使用fc3d
...
const currentMainPlay = ref('fc3d_3x')
...
const handleDirectBet = async () => {
  ...
  const amount = currentBetCount.value * betMode.value * betMultiplier.value * 2 // 福彩3D基础单价2元
