    ...
    <div class="footer-standard">
      ...
      <div class="footer-row top-row">
        <div class="settings-group">
          ...
          <van-dropdown-menu class="unit-selector" direction="up">
      ...
      <div class="footer-row bottom-row">
        <div class="actions-left">
           ...
           <div class="action-icon-btn basket-btn" @click="$emit('open-basket')">
             <van-icon name="shopping-cart-o" size="20" />
             <span>号码篮</span>
             <div class="badge" v-if="basketCount > 0">{{ basketCount }}</div>
           </div>
...
const props = defineProps({
  ...
  basketCount: { type: Number, default: 0 } // 新增：购物车数量
});

const emit = defineEmits(['update:mode', 'update:multiple', 'clear', 'add-to-cart', 'open-hemai', 'submit', 'open-basket']);
