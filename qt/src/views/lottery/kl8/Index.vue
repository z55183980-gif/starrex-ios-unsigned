...
import Kl8LotteryInfo from './components/Kl8LotteryInfo.vue'
...
const mockOpenCode = ref([1, 3, 5, 8, 10, 12, 15, 18, 20, 22, 41, 43, 45, 48, 50, 52, 55, 58, 60, 62])
...
function addToBasket() {
  ...
  const betItem = {
    ...
    mode: betMode.value,
    money: totalMoney.value, // Uses computed totalMoney
