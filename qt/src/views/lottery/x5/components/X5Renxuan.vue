<template>
  <div class="x5-renxuan">
    <div class="group-box">
      <div class="box-header">
        <div class="title">选号区</div>
      ...
      <div class="filter-bar">
        <div class="tool-btn" @click="selectorFilter('all')">全</div>
        <div class="tool-btn" @click="selectorFilter('big')">大</div>
        <div class="tool-btn" @click="selectorFilter('small')">小</div>
        <div class="tool-btn" @click="selectorFilter('odd')">奇</div>
        <div class="tool-btn" @click="selectorFilter('even')">偶</div>
...
const ballList = computed(() => {
    return Array.from({length: 11}, (_, i) => {
        ...
        return {
            val: n,
            label: n < 10 ? '0'+n : ''+n,
            omission: Math.floor(Math.random() * 15) // Mock omission
        }
    })
})
